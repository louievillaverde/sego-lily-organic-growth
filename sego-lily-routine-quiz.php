...
add_action( 'plugins_loaded', array( 'SLRQ_Completions', 'install' ) );
add_action( 'plugins_loaded', array( 'SLRQ_Subscriptions', 'init' ) );
...
/**
 * Auto-apply the FREESHIPPING coupon during the announced offer window so
 * customers don&rsquo;t have to type a code (currently the July 4 2026
 * free-shipping weekend, through Sun 7/5 11:59pm MT). Update the dates in the
 * template_redirect hook below to move the window. Outside it, nothing fires.
 *
...
add_filter( 'woocommerce_package_rates', function( $rates, $package ) {
	...
	$end   = new DateTime( '2026-05-27 23:59', $mt );
...
/**
 * The results-page free-shipping callout is intentionally disabled. The
 * customer already saw the offer in the email they clicked from, and the
 * auto-applied coupon shows in the cart totals after they add. A separate
 * callout card on the results page just competes with the primary
 * "Add to cart" CTAs.
 */
